...
loc='/nfs/bsc01/researchData/USER/tbruijne/Research_data/MR21/20171018_MPRage_noise_sensor/Scan5/20171106_173456_s_T2_3D_TSE_FLAIR_corrupted.raw';
loc2='/nfs/bsc01/researchData/USER/tbruijne/Research_data/MR21/20171018_MPRage_noise_sensor/Scan5/';
MR=MRecon(loc);
...
%Load the logical exclusion sarray
cd(loc2)
load('corrupted2.mat')
cd('/home/tbruijne/Documents/Side_projects/Head_motion_noise_sensor');
...
% load csm
load('/nfs/bsc01/researchData/USER/tbruijne/Research_data/MR21/20171018_MPRage_noise_sensor/Scan4/csm.mat');
...
%  a3=reg_cgsense(:,:,ro);
%  m=m/max(m(:));
%  figure,imshow3(rot90(cat(3,a1/max(a1(:)),a2/max(a2(:)),a3/max(a3(:)),m),3),[0 0.7],[1 4]);
...
cd('/nfs/bsc01/researchData/USER/tbruijne/Research_data/MR21/20171018_MPRage_noise_sensor/Scan5/')
%sos_motion=flip(imgaussfilt(rot90(sos_img,3),.2),3);
%pi_motion=flip(imgaussfilt(rot90(reg_cgsense,3),.2),3);
%no_motion=single(flip(imgaussfilt(rot90(sos_img,3),.2),3));
zf_motion=single(flip(imgaussfilt(rot90(sos_img,3),.2),3));
pi_motion=single(flip(imgaussfilt(rot90(reg_cgsense,3),.2),3));
save('recons.mat','zf_motion','pi_motion','-append')
save('recons.mat','no_motion','-append')
